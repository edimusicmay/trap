...
if (ctx && !gameEnded) {
  ...
  if (multiplierBroken && performance.now() - multiplierResetTime < 2000 && lastMultiplier > 1) {
  ...
  ctx.textAlign = "left";
  ctx.fillText("Perfect streak: x" + multiplier, 10, 100);
  ctx.shadowBlur = 0;
}
...
streakDisplayTimeout = performance.now() + 2000; // show for 2 seconds
